...
def load_schema():
    ...
    schema_path = os.path.join(os.path.dirname(__file__), '..', 'src', 'data', 'content_schema.json')
...
def load_content():
    ...
    content_path = os.path.join(os.path.dirname(__file__), '..', 'src', 'data', 'content.json')
...
class TestSchemaValidation:
    ...
    def test_schema_rejects_invalid_greetings(self):
        ...
        invalid_content = {
            "messages": {
                "greetings": [
                    "Hello! Welcome to MCP!"  # Missing {name} placeholder
                ]
            }
        }
    ...
    def test_schema_rejects_empty_greetings(self):
        ...
        invalid_content = {
            "messages": {
                "greetings": []  # Empty array not allowed
            }
        }
