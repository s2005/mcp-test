...
class TestPromptSimplification:
    ...
    def test_simple_template_substitution(self):
        ...
        prompt_func = loader.create_prompt_function("simple_prompt", prompts["simple_prompt"])
        ...
        assert result[0]["content"] == "Hello TestUser! Your skill level is intermediate."
    ...
    def test_existing_prompt_functionality_preserved(self):
        ...
        prompts = loader.load_prompts()
        prompt_func = loader.create_prompt_function("test_prompt", prompts["test_prompt"])
    ...
    def test_missing_placeholder_handling(self):
        ...
        prompts = loader.load_prompts()
        prompt_func = loader.create_prompt_function("incomplete_prompt", prompts["incomplete_prompt"])
    ...
    def test_dynamic_prompts_with_various_templates(self):
        ...
        for i, test_case in enumerate(test_cases):
            ...
            prompts = loader.load_prompts()
            prompt_func = loader.create_prompt_function(f"test_prompt_{i}", prompts[f"test_prompt_{i}"])
    ...
    def test_prompt_function_metadata(self):
        ...
        prompts = loader.load_prompts()
        prompt_func = loader.create_prompt_function("metadata_test", prompts["metadata_test"])
