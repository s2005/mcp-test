...
class TestCompleteIntegration(unittest.TestCase):
    ...
    def test_complete_content_loading(self):
        ...
        try:
            ...
            self.assertEqual(loaded_content["messages"], self.complete_content["messages"])
            self.assertEqual(loaded_content["prompts"], self.complete_content["prompts"])
    ...
    def test_complete_server_registration(self, mock_prompt_registry, mock_tips_resources,
                                        mock_tips_tools, mock_greeting_tools, mock_time_tools):
    ...
    def test_performance_with_large_content(self):
        ...
        large_content = {
            "tips": {},
            "messages": {
                "greetings": [f"Hello {i}!" for i in range(100)]
            },
            "prompts": {}
        }
        ...
        for i in range(50):
            large_content["tips"][f"category_{i}"] = [f"Tip {j} for category {i}" for j in range(20)]
