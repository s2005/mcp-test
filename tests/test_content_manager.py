...
class TestContentManager:
    ...
    def test_get_greetings_success(self):
        ...
        content = {
            "messages": {
                "greetings": ["Hello {name}! Welcome!", "Hi {name}! Great to see you!"]
            }
        }
        manager = ContentManager(content)
    ...
    def test_get_tips_default_category(self):
        ...
        content = {"tips": {"mcp": ["Tip 1", "Tip 2"], "python": ["Python tip"]}}
        manager = ContentManager(content)
    ...
    def test_get_tips_specific_category(self):
        ...
        content = {
            "tips": {"mcp": ["MCP tip"], "python": ["Python tip 1", "Python tip 2"]}
        }
        manager = ContentManager(content)
    ...
    def test_get_tip_categories(self):
        ...
        content = {"tips": {"mcp": ["tip1"], "python": ["tip2"], "docker": ["tip3"]}}
        manager = ContentManager(content)
    ...
    def test_get_all_messages(self):
        ...
        content = {
            "messages": {"greetings": ["Hello {name}!"], "farewells": ["Goodbye!"]}
        }
        manager = ContentManager(content)
...
class TestContentManagerDynamic:
    ...
    def test_edge_cases(self):
        ...
        edge_content = {
            "tips": {},  # Empty tips
            "messages": {"greetings": []},  # Empty greetings
            "prompts": {"empty_category": {}},  # Empty prompt category
        }
