...
class PromptRegistry:
    ...
    def _register_single_prompt(self, mcp, loader: JSONPromptLoader, prompt_name: str, prompt_def: Dict[str, Any]) -> None:
        """
    ...
    def _add_mcp_annotations(self, func, prompt_def: Dict[str, Any]) -> None:
        ...
        if arguments:
            ...
            docstring_parts.append("\nReturns:")
            docstring_parts.append("    List of message dictionaries for the prompt template")
